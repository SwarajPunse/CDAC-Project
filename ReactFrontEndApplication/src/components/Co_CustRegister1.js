...
export default function Co_CustRegister1() {
    ...
    const init = {
        ...
        firmname: { value: "", touched: false, valid: false, error: "" },
        ...
        mobile_no: { value: "", touched: false, valid: false, error: "" },
         ...
         gst_no: { value: "", touched: false, valid: false, error: "" },
    ...
    const validateData = (name, value) => {
        ...
        switch (name) {
            ...
            break;
            case 'firmname': var pattern = /^[A-Z][a-z]{2,15}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
                ...
                break;
            case 'gst_no': var pattern = /^[0-9]{2,15}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
            ...
            case 'question': var pattern = /^[0-9]$/
                ...
                break;
            case 'answer': var pattern = /^[A-Za-z]{2,15}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
    ...
    const onFocusout = (name, value) => {
        ...
        dispatch({ type: 'update', data: { name, value, touched: true, valid, error } })
    }
    ...
    return (
        <div className="container">
          <h2>Corporate Customer Registration</h2>
            <form>
               
            <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputUsername">Username</label>
                        <input type="text" class="form-control" name="username" id="inputUserFname" placeholder="username" value={info.username.value}
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="firmname" id="firmname" placeholder="firmname"
                            onChange={(e) => handleChange("firmname", e.target.value)} />
                        <div className="error-msg"> {info.firmname.error}</div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div className="error-msg"> {info.gst_no.error}</div>
                    </div>
                </div>
        ...
        <input type="text" className="form-control" id="answer" placeholder="Enter the answer" name="answer" 
         ...
         onChange={(e) => handleChange("m_id", e.target.value)}>
            <option placeholder="select" id="m_id" value={0}>select</option>
            <option id="m_id" value={3}>Co_Diamond</option>
            <option id="m_id" value={2}> Co_platinum</option>
            <option id="m_id" value={1}>Co_gold</option>
             </select>
...
//         email: { value: "", touched: false, valid: false, error: "" },
//         mobile_id: { value: "", touched: false, valid: false, error: "" },
//          address:{ value: "", touched: false, valid: false, error: "" },
//         studio:{ value: "", touched: false, valid: false, error: "" },
//          question:{ value: "", touched: false, valid: false, error: "" },
//         answer:{ value: "", touched: false, valid: false, error: "" },
//          m_id:{ value: "", touched: false, valid: false, error: "" },
...
//                 }
//                 break;
//             case 'mobile_id': var pattern = /^[0-9]{10}$/
//                 if (pattern.test(value)) {
//                     valid = true;
//                     error = "";
//                 }
...
//                 }
//                 break;
//             case 'studio': var pattern = /^[A-Za-z]{2,15}$/
//                 if (pattern.test(value)) {
//                     valid = true;
//                     error = "";
//                 }
//                 else {
//                     valid = false;
//                     error = "Studio Name invalid"
//                 }
//                 break;
//             case 'question': var pattern = /^$/
//                 if (pattern.test(value)) {
//                     valid = true;
//                     error = "";
//                 }
...
//                 }
//                 break;
//                 case 'm_id': var pattern = /^[A-Za-z,@,-,#,^]{2,15}$/
//                 if (pattern.test(value)) {
//                     valid = true;
//                     error = "";
//                 }
...
//                 <div class="form-row">
//                     <div class="form-group col-md-6">
//                         <label for="mobile_id">Contact number</label>
//                         <input type="text" class="form-control" name="mobile_id" id="mobile_id" placeholder="Contact number"
//                             onChange={(e) => handleChange("mobile_id", e.target.value)} />
//                         <div className="error-msg"> {info.mobile_id.error}</div>
//                     </div>
//                 </div>
...
//                         <input type="text" name="studio" class="form-control" id="studio" 
//                         onChange={(e) => handleChange("studio", e.target.value)} />
//                          <div className="error-msg"> {info.studio.error}</div>
//                      </div>
//                 </div>

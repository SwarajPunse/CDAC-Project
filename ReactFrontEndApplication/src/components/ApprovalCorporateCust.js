...
export default function ApprovalCorporateCust()
{
    ...
    useEffect(()=>{
        ...
        fetch("http://localhost:8080/getalllogCoCust")
        .then(res=>res.json())
    ...
    return(
        <div>
            ...
            <h2 className="text-center"><b>Corporate Customer Approval Details</b></h2>
